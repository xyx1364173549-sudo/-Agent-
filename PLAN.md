...
- [x] M1.1 统一聊天模型工厂 — 交付：`src/llm/factory.py`，DeepSeek 与小米 MiMo（OpenAI 兼容）双通道
...
| 2026-09-16 | M1.1 完成：统一聊天模型工厂 `src/llm/factory.py`（双提供方映射 + 超参校验 + 密钥防泄漏），新增 44 条用例，累计 135 条全绿 |
